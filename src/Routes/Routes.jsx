...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://summer-camp-new-test.vercel.appsee-classes/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://summer-camp-new-test.vercel.appclass/${params.id}`)
            },
            // student routes
            {
                path: "selected-class",
