...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://summer-camp-new-test-adittacse.vercel.app/see-classes/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://summer-camp-new-test-adittacse.vercel.app/class/${params.id}`)
            },
            // student routes
            {
                path: "selected-class",
