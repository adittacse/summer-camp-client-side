...
const ManageUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://summer-camp-new-test.vercel.app/users/user-to-admin/${user._id}`, {
                    method: "PATCH"
                })
                    .then(res => res.json())
                    .then(data => {
    ...
    const handleMakeInstructor = (user) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://summer-camp-new-test.vercel.app/users/admin-to-instructor/${user._id}`, {
                    method: "PATCH"
                })
                    .then(res => res.json())
                    .then(data => {
