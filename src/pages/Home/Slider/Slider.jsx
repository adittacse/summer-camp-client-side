...
const Slider = () => {
    ...
    return (
        <div className="mb-10 text-center">
            <Carousel showThumbs={true} infiniteLoop autoPlay interval={5000} transitionTime={500} emulateTouch swipeable showArrows>
                <div className="h-60 md:h-fit lg:h-[550px]">
